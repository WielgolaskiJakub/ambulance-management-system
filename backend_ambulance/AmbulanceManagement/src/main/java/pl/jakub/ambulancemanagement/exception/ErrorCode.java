...
public enum ErrorCode {
    ...
    REFUELING_ACCESS_DENIED("REFUELING_ACCESS_DENIED",
            "error.refueling_access_denied", HttpStatus.FORBIDDEN),
    ROUTE_ACCESS_DENIED("ROUTE_ACCESS_DENIED",
            "error.route_access_denied", HttpStatus.FORBIDDEN),
    ...
    SHIFT_ACCESS_DENIED("SHIFT_ACCESS_DENIED",
            "error.shift_access_denied", HttpStatus.FORBIDDEN),
    TRANSPORT_ORDER_ACCESS_DENIED("TRANSPORT_ORDER_ACCESS_DENIED",
            "error.transport_order_access_denied", HttpStatus.FORBIDDEN),
    ...
    ROUTE_TRANSPORT_ORDER_CANNOT_BE_CANCELLED("ROUTE_TRANSPORT_ORDER_CANNOT_BE_CANCELLED",
